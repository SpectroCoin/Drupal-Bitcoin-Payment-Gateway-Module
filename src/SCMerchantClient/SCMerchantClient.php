...
use SCMerchantClient\data\ApiError;
use SCMerchantClient\data\OrderCallback;
use SCMerchantClient\messages\CreateOrderRequest;
use SCMerchantClient\messages\CreateOrderResponse;
...
class SCMerchantClient
{
    ...
    function __construct($merchantApiUrl, $userId, $merchantApiId, $debug = false)
    {
        ...
        $this->publicSpectroCoinCertLocation = 'https://commerce_spectrocoin.com/files/merchant.public.pem';
